 ...
 *
 * If you are the first person to point this at Firebird: run smoketest.mjs and
 * regressiontest.mjs before trusting a single number. The driver is written from
 * the documented behaviour of isql, not from a live system.
 */
